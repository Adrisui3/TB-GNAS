...
class TestSpaceComponent:
    ...
    def test_learning_component(self):
        ...
        layer.learn(geom_nn.GATv2Conv.__name__, True)
        assert layer.get_scores()[geom_nn.GATv2Conv.__name__] == 2

        layer.learn(geom_nn.GATv2Conv.__name__, False)
        assert layer.get_scores()[geom_nn.GATv2Conv.__name__] == 1
